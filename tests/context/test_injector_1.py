...
class TestRelevanceScoring:
    ...
    def test_calculate_usage_score(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # High usage
            score_high = injector._calculate_usage_score(
                ref_count=100, max_refs=100
            )
            assert score_high > 0.8
            
            # Low usage
            score_low = injector._calculate_usage_score(
                ref_count=5, max_refs=100
            )
    ...
    def test_combined_relevance_score(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            score = injector.calculate_relevance_score(
                ...
                current_file="/home/project/src/main.py"
            )
