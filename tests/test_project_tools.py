...
class TestDependencyGraphSrcLayout:
    ...
    def test_src_layout_deps(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            root = _make_project(tmp, layout="src", files={
            ...
            assert "src/mypkg/core.py" in main_deps, f"Expected src/mypkg/core.py in deps, got {main_deps}"
    ...
    def test_parent_relative_imports(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            assert "src/mypkg/core/base.py" in main_deps, f"Expected src/mypkg/core/base.py in deps, got {main_deps}"
...
class TestProjectVerifyOutput:
    ...
    def test_ok_status_small_output(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            assert result["status"] == "ok", f"Expected ok, got {result['status']}: {result['diffs']}"
...
class TestFrameworkDetection:
    ...
    def test_conftest_presence(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            framework, count, cmd = _detect_test_framework(root)
...
class TestEntryPointDetection:
    ...
    def test_project_scripts(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            entries = _detect_entry_points(root)
            assert any("mytool" in e or "mypkg.core:main" in e for e in entries), f"Expected mytool entry, got {entries}"
...
class TestTreeSitterBackend:
    ...
    def test_ts_backend_module_exists(self):
        ...
        from ts_backend import ts_parse, ts_grep, ts_read
    ...
    def test_ts_grep_function_definition(self):
        ...
        from ts_backend import ts_parse, ts_grep
        source = "def hello():\n    pass\ndef world():\n    pass\n"
        tree = ts_parse(source, lang="python")
...
class TestIncrementalScanning:
    ...
    def test_changed_file_updates_hash(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            core_key = [k for k in hashes2 if "core.py" in k][0]
...
class TestFindReferences:
    ...
    def test_finds_known_references(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            assert any("main.py" in f for f in files_found), f"Expected main.py in results, got {files_found}"
...
class TestImpactAnalysis:
    ...
    def test_transitive_dependents(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            assert "mypkg/main.py" in transitive, f"Expected mypkg/main.py in transitive, got {transitive}"
    ...
    def test_test_files_detected(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            assert any("test_core.py" in tf for tf in test_files), f"Expected test_core.py, got {test_files}"
    ...
    def test_symbol_based_impact(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            assert any("main.py" in f for f in caller_files), f"Expected main.py in callers, got {caller_files}"
