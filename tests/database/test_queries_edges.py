...
class TestEdgeQueries:
    ...
    def test_insert_and_find_edge(self, db_conn: sqlite3.Connection):
        ...
        # Setup symbols
        s1 = Symbol(id="f1.py:s1", name="s1", qualified_name="s1", kind=SymbolKind.FUNCTION, 
                   file_path="f1.py", start_line=1, end_line=1, signature="", docstring="", 
                   is_public=True, content_hash="h1")
        s2 = Symbol(id="f2.py:s2", name="s2", qualified_name="s2", kind=SymbolKind.FUNCTION, 
                   file_path="f2.py", start_line=1, end_line=1, signature="", docstring="", 
        ...
        insert_edge(db_conn, source_id="f1.py:s1", target_name="s2", 
                    edge_type=EdgeKind.CALLS.value, target_id="f2.py:s2")
    ...
    def test_insert_edges_batch(self, db_conn: sqlite3.Connection):
        ...
        from ast_tools.database.queries import insert_symbols_batch
        symbols = [
            Symbol(id="f1.py:s1", name="s1", qualified_name="s1", kind=SymbolKind.FUNCTION,
                   file_path="f1.py", start_line=1, end_line=1, signature="", docstring="",
                   is_public=True, content_hash="h1"),
            Symbol(id="f2.py:t1", name="t1", qualified_name="t1", kind=SymbolKind.FUNCTION,
                   file_path="f2.py", start_line=1, end_line=1, signature="", docstring="",
                   is_public=True, content_hash="h2"),
            Symbol(id="f2.py:t2", name="t2", qualified_name="t2", kind=SymbolKind.FUNCTION,
                   file_path="f2.py", start_line=1, end_line=1, signature="", docstring="",
                   is_public=True, content_hash="h3"),
        ]
    ...
    def test_get_symbol_edges(self, db_conn: sqlite3.Connection):
        ...
        symbols = [
            Symbol(id="f1.py:s1", name="s1", qualified_name="s1", kind=SymbolKind.FUNCTION,
                   file_path="f1.py", start_line=1, end_line=1, signature="", docstring="",
                   is_public=True, content_hash="h1"),
            Symbol(id="f2.py:s2", name="s2", qualified_name="s2", kind=SymbolKind.FUNCTION,
                   file_path="f2.py", start_line=1, end_line=1, signature="", docstring="",
                   is_public=True, content_hash="h2"),
            Symbol(id="f2.py:t1", name="t1", qualified_name="t1", kind=SymbolKind.FUNCTION,
                   file_path="f2.py", start_line=1, end_line=1, signature="", docstring="",
            ...
            Symbol(id="f2.py:t2", name="t2", qualified_name="t2", kind=SymbolKind.FUNCTION,
                   file_path="f2.py", start_line=1, end_line=1, signature="", docstring="",
                   is_public=True, content_hash="h4"),
        ]
        insert_symbols_batch(db_conn, symbols)
