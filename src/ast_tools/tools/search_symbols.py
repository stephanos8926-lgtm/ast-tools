...
from ..database import search_symbols as db_search_symbols, database_context
                ...
                "results": [
                    {
                        ...
                        "docstring": row["docstring"][:200] + "..." if row["docstring"] and len(row["docstring"]) > 200 else row["docstring"],
                    }
                    for row in results
                ],
                "count": len(results),
