...
def _tool_code_validate(params: dict[str, Any]) -> dict[str, Any]:
            ...
            "errors": [
                {
                    "line": 0,
                    "column": 0,
                    "message": f"Unsupported language: {language}. Supported: {', '.join(VALIDATORS.keys())}",
                }
            ],
            "warnings": [],
            "parser_used": "none",
    ...
    try:
        ...
        return {
            "valid": False,
            "errors": [{"line": 0, "column": 0, "message": f"Validator error: {e!s}"}],
            "warnings": [],
...
def _validate_python(content: str, file_path: str | None = None) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "valid": False,
            "errors": [
                {"line": e.lineno or 0, "column": e.offset or 0, "message": f"SyntaxError: {e.msg}"}
            ],
            "warnings": [],
    ...
    try:
        ...
        if not parsed:
            return {
                "valid": False,
                "errors": [
                    {"line": 0, "column": 0, "message": "Failed to parse SQL: no statements found"}
                ],
                "warnings": [],
            ...
            "errors": [
                {
                    "line": 0,
                    "column": 0,
                    "message": "sqlparse not installed. Install with: pip install sqlparse",
                }
            ],
            "warnings": [],
            "parser_used": "none",
        ...
        return {
            "valid": False,
            "errors": [{"line": 0, "column": 0, "message": f"SQL parse error: {e!s}"}],
            "warnings": [],
            "parser_used": "sqlparse",
        }
...
def _validate_shell(content: str, file_path: str | None = None) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "valid": False,
            "errors": [
                {"line": 0, "column": 0, "message": "Timeout after 5s. Script may be too complex."}
            ],
            "warnings": [],
            "parser_used": "bash",
        }
        ...
        return {
            "valid": False,
            "errors": [
                {"line": 0, "column": 0, "message": "bash not found. Install bash or check PATH."}
            ],
            "warnings": [],
            "parser_used": "none",
        }
        ...
        return {
            "valid": False,
            "errors": [{"line": 0, "column": 0, "message": f"Permission denied: {e!s}"}],
            "warnings": [],
            "parser_used": "none",
        }
    except OSError as e:
        return {
            "valid": False,
            "errors": [{"line": 0, "column": 0, "message": f"OS error: {e!s}"}],
            "warnings": [],
            "parser_used": "none",
        }
...
def _validate_typescript(content: str, file_path: str | None = None) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "valid": False,
            "errors": [{"line": 0, "column": 0, "message": f"TypeScript error: {e!s}"}],
            "warnings": [],
            "parser_used": "tsc",
        }
...
def _validate_rust(content: str, file_path: str | None = None) -> dict[str, Any]:
    ...
    try:
            ...
            "errors": [
                {
                    "line": 0,
                    "column": 0,
                    "message": "rustc not found. Install Rust: https://rustup.rs",
                }
            ],
            "warnings": [],
            "parser_used": "none",
        ...
        return {
            "valid": False,
            "errors": [{"line": 0, "column": 0, "message": f"Rust error: {e!s}"}],
            "warnings": [],
            "parser_used": "rustc",
        }
...
def _validate_go(content: str, file_path: str | None = None) -> dict[str, Any]:
    ...
    try:
        ...
        return {
            "valid": False,
            "errors": [
                {"line": 0, "column": 0, "message": "go not found. Install Go: https://go.dev"}
            ],
            "warnings": [],
            "parser_used": "none",
        }
        ...
        return {
            "valid": False,
            "errors": [{"line": 0, "column": 0, "message": f"Go error: {e!s}"}],
            "warnings": [],
            "parser_used": "go",
        }
    ...
    try:
        ...
        if tree.root_node.type == "ERROR":
            return {
                "valid": False,
                "errors": [
                    {"line": 0, "column": 0, "message": f"Syntax error in {lang_name} code"}
                ],
                "warnings": [],
            ...
            "errors": [
                {
                    "line": 0,
                    "column": 0,
                    "message": f"{package_name} not installed. Install with: pip install {package_name}",
                }
            ],
            "warnings": [],
            "parser_used": "none",
        ...
        return {
            "valid": False,
            "errors": [{"line": 0, "column": 0, "message": f"tree-sitter error: {e!s}"}],
            "warnings": [],
            "parser_used": f"tree-sitter ({package_name})",
        }
