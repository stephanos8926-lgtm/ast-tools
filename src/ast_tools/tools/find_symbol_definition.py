...
from ..database import find_symbol_definition as db_find_symbol, database_context
        ...
        with database_context() as conn:
            ...
            return {
                ...
                "symbol": {
                    ...
                    "docstring": result["docstring"][:500] + "..." if result["docstring"] and len(result["docstring"]) > 500 else result["docstring"],
