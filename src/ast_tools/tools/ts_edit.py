...
def _rename_identifier(source: str, old_name: str, new_name: str, lang: str) -> dict:
    ...
    return {"success": True, "changes": len(matches), "modified_source": modified}
...
def _add_parameter(
    ...
    return {"success": True, "function": func_name, "added": new_param, "modified_source": modified}
...
def _replace_node(source: str, query: str, replacement: str, lang: str) -> dict:
    ...
    return {"success": True, "replaced": True, "modified_source": modified}
...
def ts_edit(
    ...
    if operation == "rename_identifier":
        result = _rename_identifier(source, params.get("old_name"), params.get("new_name"), lang)
        ...
        result = _replace_node(source, params.get("query"), params.get("replacement"), lang)
    else:
