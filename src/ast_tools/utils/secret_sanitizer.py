...
class SecretSanitizer:
    ...
    def __init__(self, redaction: str | None = None, extra_patterns: list[str] | None = None):
    ...
    def sanitize(self, data: Any) -> Any:
        ...
        if isinstance(data, Mapping):
            ...
            for k, v in data.items():
                ...
                safe_v = self._sanitize_value(k, v) if isinstance(k, str) else v
    ...
    def _sanitize_string(self, value: str) -> str:
        ...
        if self._is_high_entropy(value) and len(value) >= 20 and not self._is_likely_text(value):
