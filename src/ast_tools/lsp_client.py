...
class LSPClient:
    ...
    def goto_definition(self, file: str, line: int, col: int) -> Optional[dict]:
    ...
    def call_hierarchy_incoming(self, file: str, line: int, col: int) -> list[dict]:
        ...
        result = self._send_request('callHierarchy/incomingCalls', {
            'item': items[0]
        })
        return result or []
    ...
    def call_hierarchy_outgoing(self, file: str, line: int, col: int) -> list[dict]:
        ...
        result = self._send_request('callHierarchy/outgoingCalls', {
            'item': items[0]
        })
        return result or []
    ...
    def signature_help(self, file: str, line: int, col: int) -> Optional[str]:
...
def get_lsp_client(file: str, root: str = None) -> LSPClient:
