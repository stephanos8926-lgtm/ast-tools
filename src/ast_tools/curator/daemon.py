...
from ..database.queries import search_symbols
...
class LLmCurator:
                    ...
                    if symbols:
                        ...
                        for sym in symbols:
                            ...
                            """, (
                                ...
                                sym.line, sym.signature, sym.docstring,
                                emb, now
                            ))
    ...
    def generate_project_summary(self, output_path: Optional[str] = None) -> str:
        ...
        try:
            cursor = conn.execute("""
                SELECT DISTINCT symbol, kind, file_path, signature
                FROM symbols
...
def run_daily_audit(project_root: Optional[str] = None) -> dict:
